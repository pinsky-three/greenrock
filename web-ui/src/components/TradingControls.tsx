    ...
    <div className="flex flex-col h-full bg-neutral-900 text-white">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-700">
        ...
        <div className="flex items-center space-x-2">
          <button
            onClick={loadData}
            disabled={loading}
            className="text-xs bg-blue-600 hover:bg-blue-700 disabled:bg-neutral-600 px-2 py-1 rounded"
          >
          ...
          <div className="space-y-3">
            {openOrders.length === 0 ? (
              ...
              openOrders.map((order) => (
                <div key={order.id} className="bg-neutral-800 p-3 rounded-lg">
          ...
          <div className="space-y-3">
            {tradeHistory.length === 0 ? (
              ...
              tradeHistory.slice(0, 50).map((trade) => (
                <div key={trade.id} className="bg-neutral-800 p-3 rounded-lg">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <span
                        className={`text-sm font-medium ${
      ...
      <div className="p-4 border-t border-gray-700">
        <div className="flex space-x-2">
          <button className="flex-1 bg-emerald-600 hover:bg-emerald-700 py-2 rounded text-sm font-medium">
            Place Buy Order
          </button>
          <button className="flex-1 bg-rose-600 hover:bg-rose-700 py-2 rounded text-sm font-medium">
            Place Sell Order
          </button>
        </div>
